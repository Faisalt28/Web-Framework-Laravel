            ...
            <div class="col-auto ms-auto d-print-none">
              <div class="btn-list">
                <a href="{{ route('users.create') }}" class="btn btn-primary d-none d-sm-inline-block"
                  ...
                  <span style="color: #fff; font-weight: bold;">Tambah Pengguna</span>
                </a>
            ...
            <tbody class="table-tbody">
              @forelse ($users as $user)
                <tr>
                  ...
                  <td class="sort-peran">{{ optional($user->role)->name ?? 'Belum ada peran' }}</td>
                  <td class="sort-biodata">{{ Str::limit($user->profile->biodata, 50) }}</td>
                  ...
                  <td class="sort-aksi">
                    <div class="btn-group" role="group">
                      <a href="{{ route('users.show', $user->id) }}" class="btn btn-sm btn-info" style="margin-right: 5px;">Lihat</a>
                      <a href="{{ route('users.edit', $user->id) }}" class="btn btn-sm btn-warning" style="margin-right: 5px;">Ubah</a>
